...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
    {
        ...
        MoveToEx(hdc, x - 150 * scaleX, y - 100 * scaleY, NULL);
        LineTo(hdc, x - 250 * scaleX, y - 100 * scaleY);

        MoveToEx(hdc, x - 150 * scaleX, y - 100 * scaleY, NULL);
        LineTo(hdc, x - 230 * scaleX, y - 10 * scaleY);

        MoveToEx(hdc, x - 187 * scaleX, y - 60 * scaleY, NULL);
        LineTo(hdc, x - 150 * scaleX, y - 4 * scaleY);

        MoveToEx(hdc, x - 100 * scaleX, y - 120 * scaleY, NULL);
        LineTo(hdc, x - 100 * scaleX, y + 20 * scaleY);

        MoveToEx(hdc, x - 200 * scaleX, y + 10 * scaleY, NULL);
        LineTo(hdc, x - 200 * scaleX, y + 60 * scaleY);

        MoveToEx(hdc, x - 200 * scaleX, y + 60 * scaleY, NULL);
        LineTo(hdc, x - 100 * scaleX, y + 60 * scaleY);
